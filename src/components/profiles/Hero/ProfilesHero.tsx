...
import styles from "./ProfilesHero.module.css";
...
export default function ProfilesHero() {
  ...
  return (
    <section className={styles.root} ref={rootRef} id="profiles">
      <div className={styles.inner}>
        ...
        <div ref={subtitleRef}>
          <Text 
            ...
            variant="large"
          >
            Showcase your brand, track performance, connect all platforms seamlessly
          </Text>
        </div>
